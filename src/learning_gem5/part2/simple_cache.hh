  ...
  private:
    ...
    class CPUSidePort : public ResponsePort
    {
      ...
      public:
         ...
         */
        CPUSidePort(const std::string& name, int id, SimpleCache* owner) : ResponsePort(name), id(id), owner(owner), needRetry(false), blockedPacket(nullptr) { }
    ...
    class MemSidePort : public RequestPort
    {
      ...
      public:
         ...
         * Constructor. Just calls the superclass constructor.
         */
        MemSidePort(const std::string& name, SimpleCache* owner) : RequestPort(name), owner(owner), blockedPacket(nullptr) { }
